        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ativos_Empresas_EmpresaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmprestimosAtivos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmprestimosAtivos_Ativos_AtivoId",
                        column: x => x.AtivoId,
                        principalTable: "Ativos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmprestimosAtivos_Funcionarios_FuncionarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmprestimosAtivos_AtivoId",
                table: "EmprestimosAtivos",
                column: "AtivoId");

            migrationBuilder.CreateIndex(
                name: "IX_EmprestimosAtivos_FuncionarioId",
                table: "EmprestimosAtivos",
